...
$cont	= $_POST ["conta"];	//atribuição do campo "conta" vindo do formulário para variavel
...
$query = "INSERT INTO `acampantes` ( `nome` ,`conta` , `equipe` , `id` ) 
VALUES ('$nome', '$cont','$equipe','')";
...
<center><button class="btn btn-default" onclick="redirecionar();">Fazer um novo cadastro</button>  <button class="btn btn-default" onclick="redirecionar2();">Voltar para P&aacute;gina Inicial</button></center>
</body>
</html>
